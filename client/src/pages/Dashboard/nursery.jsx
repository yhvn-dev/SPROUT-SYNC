...
import { Droplet, CircleQuestionMark, ChevronDown, ChevronUp, Sprout, Calendar, Wifi, WifiOff, TrendingUp,Clock} from 'lucide-react';
...
function NurseryDashboard() {
  ...
  useEffect(() => {
    ...
    loadBatches();
    loadSensors();
      console.log("TRAY GROUPS WITH COUNT ",tgWithTrayCount)
  ...
  const sortedTrayGroups = useMemo(() => {
    ...
    return [...trayGroups].sort((a, b) => {
      const nameA = String(a.tray_group_name).trim().toLowerCase();
      const nameB = String(b.tray_group_name).trim().toLowerCase();
                          ...
                          <div>
                            ...
                            <div className='flex gap-4'>
                                ...
                                <p className='text-xs sm:text-sm text-gray-500'>
                                  Trays: {getTrayCount(group.tray_group_id)}
                                </p>
                            </div>
                          </div>                        
