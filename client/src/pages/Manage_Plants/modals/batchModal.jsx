      ...
      <motion.div
        ...
        <header className="pb_modal_header px-6 py-4 border-b border-gray-200 bg-[#E8F3ED]">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={onClose}
              className="close_button w-8 h-8 flex items-center justify-center rounded-lg bg-white/5  hover:bg-white/10 hover:text-gray-200 transition-colors shrink-0">
              <X className="w-4 h-4" />
            </button>
          </div>
        </header>
