...
export const SeedlingStats = ({ activeTab, growthOvertime, batchHistoryTotal }) => {
  ...
  const statusData = [
    { name: "Grown", value: total ? +((total_grown / total) * 100).toFixed(1) : 0, color: "#027c68" },
    { name: "Dead", value: total ? +((total_dead / total) * 100).toFixed(1) : 0, color: "#ff6673" },
    { name: "Replanted", value: total ? +((total_replanted / total) * 100).toFixed(1) : 0, color: "#f0bd75" },
  ];
    ...
    ">
      <h3 className="text-sm font-semibold text-gray-800 dark:text-gray-100 mb-2 flex items-center">
        ...
        <button className="ml-2">
          <CircleQuestionMark
            onClick={handleOpenInfosModalseedlingGrowthOvertime}
            className="w-4 h-4 cursor-pointer text-gray-400 dark:text-gray-300"
          />
        </button>
      </h3>
...
">
  <h3 className="flex text-sm font-semibold text-gray-800 dark:text-gray-100 mb-2 items-center">
    ...
    <button className="ml-2">
      <CircleQuestionMark
        onClick={handleOpenInfosModalStatusDistribution}
        className="w-4 h-4 cursor-pointer text-gray-400 dark:text-gray-300"
      />
    </button>
  </h3>
  ...
  <div className=" flex-1 min-h-0 flex flex-col  items-center justify-center gap-4">
    ...
    <div className="relative w-full sm:w-1/2 h-[180px]">
      ...
      <div className="col-span-full grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div
            className={`stat_card total_seedlings_div 
              bg-gradient-to-br from-white via-green-100 to-blue-50
              dark:from-gray-800 dark:via-green-700 dark:to-blue-900
              rounded-xl shadow-sm hover:shadow-md transition-shadow p-4 flex flex-col items-center justify-center`}
          >
          ...
          {/* Total Grown */}
          <div
            className={`stat_card stat_card_icon total_grown_div 
              bg-gradient-to-br from-white to-green-50 
              dark:from-gray-800 dark:to-green-700
              rounded-xl shadow-sm hover:shadow-md transition-shadow p-4 flex flex-col items-center justify-center`}
          >
          ...
          {/* Dead Seedlings */}
          <div
            className={`stat_card stat_card_icon dead_seedlings_div 
              bg-gradient-to-br from-white to-red-50 
              dark:from-gray-800 dark:to-red-700
              rounded-xl shadow-sm hover:shadow-md transition-shadow p-4 flex flex-col items-center justify-center`} >
          ...
          {/* Replanted */}
          <div
            className={`stat_card replanted_seedlings_div 
              bg-gradient-to-br from-white to-orange-50 
              dark:from-gray-800 dark:to-orange-700
              rounded-xl shadow-sm hover:shadow-md transition-shadow p-4 flex flex-col items-center justify-center`}>
