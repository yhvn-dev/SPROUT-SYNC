...
export const SeedlingStats = ({
  ...
  return (
    <div className="w-full h-full grid gap-4 md:grid-cols-[6fr_4fr] md:grid-rows-[2fr_1fr] overflow-x-hidden">
      ...
      {/* ================= GROWTH OVER TIME ================= */}
      <div className="conb col-span-full md:col-span-1 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow p-4 flex flex-col">
      ...
      <div className="   col-span-full grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <StatCard
          ...
          darkGradient="from-blue-700 to-cyan-800"
        ...
        <StatCard
          ...
          darkGradient="from-green-800 to-green-600"
        ...
        <StatCard
          ...
          darkGradient="from-gray-100 to-pink-700"
...
/* ================= STAT CARD ================= */
const StatCard = ({ icon: Icon, value, label, gradient, darkFrom, darkTo, iconColor }) => (
  <div
    className={`stat_card
      bg-gradient-to-br 
      ${gradient} 
      ...
      transition-shadow p-4 flex flex-col items-center justify-center
    `}
  >
    ...
    <span className="text-sm text-gray-600 mt-1 dark:text-gray-400">{label}</span>
  </div>
);